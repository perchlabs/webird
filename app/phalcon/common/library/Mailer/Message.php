...
class Message
{
     ...
     * @return $this
     *
     * @see Webird\Mailer\Message::createAttachmentViaPath()
     * @see Webird\Mailer\Message::prepareAttachment()
     */
     ...
     * @return Message
     *
     * @see Webird\Mailer\Message::createAttachmentViaData()
     * @see Webird\Mailer\Message::prepareAttachment()
     */
    ...
    /**
     * Return a {@link \Webird\Mailer\Manager} instance
     *
     * @return \Webird\Mailer\Manager
     */
    ...
    protected function createAttachmentViaPath($file)
    {
        ...
        $byteStream = new FileByteStream($file);
    ...
    {
        return new Attachment($data, $name);
    }
