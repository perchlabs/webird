...
<div class="container">
  <div class="row">
    <div class="col-sm-1 pull-right">
      {{ link_to("admin/roles/create", '<i class="glyphicon glyphicon-plus-sign"></i> ' ~ _('Create Roles'), "class": "btn btn-primary text-right") }}
    </div>
  </div>
  ...
  {{ form('admin/roles/search', 'class': 'form-horizontal', 'autocomplete': 'off', 'role': 'form') }}
    ...
    <div class="form-group">
      <div class="col-md-4 col-md-offset-4 text-center">
        {{ submit_button(_('Search'), "class": "btn btn-primary") }}
      </div>
    </div>
